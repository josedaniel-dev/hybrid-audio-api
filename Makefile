...
# NEW — Added for upgrade
cli-cache-check-many:
	@$(ACTIVATE) && $(CLI) cache check-many $(ARGS)

cli-cache-consistency-report:
	@$(ACTIVATE) && $(CLI) cache consistency-report $(ARGS)

cli-cache-verify-and-repair:
	@$(ACTIVATE) && $(CLI) cache verify-and-repair $(ARGS)
...
help:
	...
	@echo "  make cli-cache-check-bucket ARGS=\"--label stem.name.jose\""
	@echo "  make cli-bucket-list ARGS=\"--prefix stems/name\""
	@echo ""
	@echo "🗃️ CLI – CACHE ADVANCED (NEW):"
	@echo "  make cli-cache-check-many ARGS=\"<...>\""
	@echo "  make cli-cache-consistency-report"
	@echo "  make cli-cache-verify-and-repair"
	@echo ""
